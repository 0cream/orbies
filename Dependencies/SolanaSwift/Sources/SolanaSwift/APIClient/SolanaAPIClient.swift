...
public protocol SolanaAPIClient {
    ...
    ///   - message: Message
    ///   - commitment: Optional
    /// - Returns: Returns fee corresponding to the message at the specified blockhash
    func getFeeForMessage(message: Message, commitment: Commitment?) async throws -> UInt64
    ...
    /// - SeeAlso https://docs.solana.com/developing/clients/jsonrpc-api#getsignaturestatuses
    ///
    func observeSignatureStatus(signature: String, timeout: Int, delay: Int) -> AsyncThrowingStream<PendingTransactionStatus, Error>
